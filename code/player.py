...
class Player(Entity):
	...
	def stamina_regenerate(self):
		if self.stamina < self.stats['stamina'] and self.stamina_recover:
			self.stamina += 0.2

	def energy_regenerate(self):
		if self.energy < self.stats['energy']:
			self.energy += 1 * self.stats['magic']
			if self.energy > self.stats['energy']:
				self.energy = self.stats['energy']
